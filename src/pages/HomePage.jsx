  ...
  return (
    <>
      ...
      <nav className="site-nav" style={{
        ...
        <div className="nav-links" style={{ display: 'flex', gap: 28, alignItems: 'center' }}>
          {[
            ...
            { href: '/podcast-y-streaming', label: 'Podcast' },
            { href: '/lanzamientos', label: 'Lanzamientos' },
          ].map(l => (
            <a key={l.href} href={l.href} style={{ fontSize: 12, fontWeight: 500, letterSpacing: '0.06em', color: 'var(--black)', textDecoration: 'none', textTransform: 'uppercase', whiteSpace: 'nowrap' }}>
              {l.label}
            </a>
          ))}
          <a
      ...
      <footer style={{ background: 'var(--black)', padding: '64px 80px 40px', color: '#666' }}>
        <div className="footer-grid" style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: 48, marginBottom: 48, paddingBottom: 48, borderBottom: '1px solid #1e1e1e' }}>
          <div>
          ...
          <div>
            <span style={footerHead}>El espacio</span>
            {[
              { href: '/salas', label: 'Las 3 salas' },
              { href: 'https://my.matterport.com/show/?m=9JaMUZrVdZC', label: 'Tour virtual 360°', ext: true },
              ...
              <a key={l.label} href={l.href} {...(l.ext ? { target: '_blank', rel: 'noopener noreferrer' } : {})}
                style={{ display: 'block', fontSize: 13, color: '#666', textDecoration: 'none', marginBottom: 10 }}
          ...
          <div>
            <span style={footerHead}>Para eventos</span>
            {[
              { href: '/conferencias', label: 'Conferencias' },
              { href: '/capacitaciones', label: 'Capacitaciones' },
          ...
          <div>
            <span style={footerHead}>Contacto</span>
            {[
              { href: 'https://wa.me/5491138255877?text=Hola%2C%20quiero%20info%20sobre%20el%20espacio', label: 'WhatsApp' },
              { href: 'https://www.instagram.com/espacioauditoriumeventos/', label: 'Instagram' },
              { href: 'https://maps.app.goo.gl/5yXfCeKArFk4hwYv8', label: 'Google Maps' },
            ].map(l => (
