...
const DURATION_OPTIONS = [
  ...
  { value: 'dias2', label: '2 días completos 🔥 -15%' },
  { value: 'dias3', label: '3 días completos 🔥 -15%' },
...
const HORARIOS = [
  ...
  { value: '13', label: '1:00 PM' }, { value: '14', label: '2:00 PM' },
  { value: '15', label: '3:00 PM' }, { value: '16', label: '4:00 PM' },
...
function calcCotizacion(duracion) {
  ...
  if (duracion === 'extra4') {
    ...
    precio = PRICES[8] * 2 * (1 - PRICES.DISCOUNT); descuento = true
    lineas = [{ label: '2 jornadas completas', valor: PRICES[8] * 2 }, { label: 'Descuento 15%', valor: -(PRICES[8] * 2 * PRICES.DISCOUNT) }]
  } else if (duracion === 'dias3') {
    precio = PRICES[8] * 3 * (1 - PRICES.DISCOUNT); descuento = true
    lineas = [{ label: '3 jornadas completas', valor: PRICES[8] * 3 }, { label: 'Descuento 15%', valor: -(PRICES[8] * 3 * PRICES.DISCOUNT) }]
