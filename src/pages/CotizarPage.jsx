  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta name="twitter:title" content="Cotizá Online — Precio Instantáneo | Espacio Auditorium" />
        <meta name="twitter:description" content="Cotizador self-service. Elegís fecha, ves precio al instante y reservás con el 30%. Sin llamadas. Recoleta, CABA." />
